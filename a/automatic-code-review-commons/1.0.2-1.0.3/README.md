# Comparing `tmp/automatic-code-review-commons-1.0.2.tar.gz` & `tmp/automatic-code-review-commons-1.0.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "automatic-code-review-commons-1.0.2.tar", last modified: Sat May 18 15:53:15 2024, max compression
+gzip compressed data, was "automatic-code-review-commons-1.0.3.tar", last modified: Mon May 20 16:24:23 2024, max compression
```

## Comparing `automatic-code-review-commons-1.0.2.tar` & `automatic-code-review-commons-1.0.3.tar`

### file list

```diff
@@ -1,13 +1,14 @@
-drwxr-xr-x   0 kielsondasilva  (1001) kielsonzinn  (1001)        0 2024-05-18 15:53:15.973515 automatic-code-review-commons-1.0.2/
--rw-r--r--   0 kielsondasilva  (1001) kielsonzinn  (1001)      935 2024-05-18 15:53:15.973515 automatic-code-review-commons-1.0.2/PKG-INFO
--rw-r--r--   0 kielsondasilva  (1001) kielsonzinn  (1001)      358 2024-05-18 15:53:05.000000 automatic-code-review-commons-1.0.2/README.md
-drwxr-xr-x   0 kielsondasilva  (1001) kielsonzinn  (1001)        0 2024-05-18 15:53:15.973515 automatic-code-review-commons-1.0.2/automatic_code_review_commons/
--rw-r--r--   0 kielsondasilva  (1001) kielsonzinn  (1001)       49 2024-05-18 15:52:11.000000 automatic-code-review-commons-1.0.2/automatic_code_review_commons/__init__.py
--rw-r--r--   0 kielsondasilva  (1001) kielsonzinn  (1001)      741 2024-05-18 15:34:38.000000 automatic-code-review-commons-1.0.2/automatic_code_review_commons/commons.py
-drwxr-xr-x   0 kielsondasilva  (1001) kielsonzinn  (1001)        0 2024-05-18 15:53:15.973515 automatic-code-review-commons-1.0.2/automatic_code_review_commons.egg-info/
--rw-r--r--   0 kielsondasilva  (1001) kielsonzinn  (1001)      935 2024-05-18 15:53:15.000000 automatic-code-review-commons-1.0.2/automatic_code_review_commons.egg-info/PKG-INFO
--rw-r--r--   0 kielsondasilva  (1001) kielsonzinn  (1001)      313 2024-05-18 15:53:15.000000 automatic-code-review-commons-1.0.2/automatic_code_review_commons.egg-info/SOURCES.txt
--rw-r--r--   0 kielsondasilva  (1001) kielsonzinn  (1001)        1 2024-05-18 15:53:15.000000 automatic-code-review-commons-1.0.2/automatic_code_review_commons.egg-info/dependency_links.txt
--rw-r--r--   0 kielsondasilva  (1001) kielsonzinn  (1001)       30 2024-05-18 15:53:15.000000 automatic-code-review-commons-1.0.2/automatic_code_review_commons.egg-info/top_level.txt
--rw-r--r--   0 kielsondasilva  (1001) kielsonzinn  (1001)       38 2024-05-18 15:53:15.973515 automatic-code-review-commons-1.0.2/setup.cfg
--rw-r--r--   0 kielsondasilva  (1001) kielsonzinn  (1001)      721 2024-05-18 15:51:58.000000 automatic-code-review-commons-1.0.2/setup.py
...
### Comparing `automatic-code-review-commons-1.0.2/PKG-INFO` & `automatic-code-review-commons-1.0.3/PKG-INFO`
...
### Comparing `automatic-code-review-commons-1.0.2/automatic_code_review_commons/commons.py` & `automatic-code-review-commons-1.0.3/automatic_code_review_commons/comment.py`
...
### Comparing `automatic-code-review-commons-1.0.2/automatic_code_review_commons.egg-info/PKG-INFO` & `automatic-code-review-commons-1.0.3/automatic_code_review_commons.egg-info/PKG-INFO`
...
### Comparing `automatic-code-review-commons-1.0.2/setup.py` & `automatic-code-review-commons-1.0.3/setup.py`
