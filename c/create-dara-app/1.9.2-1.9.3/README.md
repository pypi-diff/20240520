# Comparing `tmp/create_dara_app-1.9.2-py3-none-any.whl.zip` & `tmp/create_dara_app-1.9.3-py3-none-any.whl.zip`
...
## Comparing `create_dara_app-1.9.2.dist-info/LICENSE` & `create_dara_app-1.9.3.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `create_dara_app-1.9.2.dist-info/METADATA` & `create_dara_app-1.9.3.dist-info/METADATA`
...
## Comparing `create_dara_app-1.9.2.dist-info/RECORD` & `create_dara_app-1.9.3.dist-info/RECORD`
