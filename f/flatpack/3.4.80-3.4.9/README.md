# Comparing `tmp/flatpack-3.4.80.tar.gz` & `tmp/flatpack-3.4.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "flatpack-3.4.80.tar", last modified: Mon May 20 08:27:55 2024, max compression
+gzip compressed data, was "flatpack-3.4.9.tar", last modified: Thu May  2 22:54:15 2024, max compression
```

## Comparing `flatpack-3.4.80.tar` & `flatpack-3.4.9.tar`

### file list

```diff
@@ -1,33 +1,33 @@
-drwxr-xr-x   0 romlingroup   (501) staff       (20)        0 2024-05-20 08:27:55.426433 flatpack-3.4.80/
--rw-r--r--   0 romlingroup   (501) staff       (20)    11357 2024-01-31 06:56:56.000000 flatpack-3.4.80/LICENSE
--rw-r--r--   0 romlingroup   (501) staff       (20)     6253 2024-05-20 08:27:55.426126 flatpack-3.4.80/PKG-INFO
--rw-r--r--   0 romlingroup   (501) staff       (20)     5422 2024-05-18 05:22:15.000000 flatpack-3.4.80/README.md
-drwxr-xr-x   0 romlingroup   (501) staff       (20)        0 2024-05-20 08:27:55.423674 flatpack-3.4.80/flatpack/
--rw-r--r--   0 romlingroup   (501) staff       (20)      138 2024-05-02 14:39:05.000000 flatpack-3.4.80/flatpack/__init__.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     2494 2024-05-02 07:38:12.000000 flatpack-3.4.80/flatpack/agent_manager.py
--rw-r--r--   0 romlingroup   (501) staff       (20)      407 2024-01-31 06:56:56.000000 flatpack-3.4.80/flatpack/config.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     1029 2024-01-31 06:56:56.000000 flatpack-3.4.80/flatpack/datasets.py
-drwxr-xr-x   0 romlingroup   (501) staff       (20)        0 2024-05-20 08:27:55.425042 flatpack-3.4.80/flatpack/engines/
--rw-r--r--   0 romlingroup   (501) staff       (20)        0 2024-04-29 23:17:03.000000 flatpack-3.4.80/flatpack/engines/__init__.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     1099 2024-05-19 18:38:01.000000 flatpack-3.4.80/flatpack/engines/engine_llama_cpp.py
--rw-rw-r--   0 romlingroup   (501) staff       (20)     1057 2023-09-28 21:46:27.000000 flatpack-3.4.80/flatpack/instructions.py
--rw-r--r--   0 romlingroup   (501) staff       (20)       52 2024-05-18 04:12:26.000000 flatpack-3.4.80/flatpack/load_engines.py
--rw-r--r--   0 romlingroup   (501) staff       (20)       59 2024-01-31 06:56:56.000000 flatpack-3.4.80/flatpack/load_modules.py
--rw-r--r--   0 romlingroup   (501) staff       (20)    34651 2024-05-19 11:30:30.000000 flatpack-3.4.80/flatpack/main.py
-drwxr-xr-x   0 romlingroup   (501) staff       (20)        0 2024-05-20 08:27:55.425506 flatpack-3.4.80/flatpack/modules/
--rw-r--r--   0 romlingroup   (501) staff       (20)        0 2024-01-31 06:56:56.000000 flatpack-3.4.80/flatpack/modules/__init__.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     4297 2024-01-31 06:56:56.000000 flatpack-3.4.80/flatpack/modules/lstm.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     4292 2024-01-31 06:56:56.000000 flatpack-3.4.80/flatpack/modules/rnn.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     6983 2024-05-14 17:52:21.000000 flatpack-3.4.80/flatpack/parsers.py
--rw-r--r--   0 romlingroup   (501) staff       (20)      290 2024-04-27 11:31:48.000000 flatpack-3.4.80/flatpack/session_manager.py
--rw-r--r--   0 romlingroup   (501) staff       (20)      184 2024-01-31 06:56:56.000000 flatpack-3.4.80/flatpack/utils.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     6745 2024-05-20 08:26:11.000000 flatpack-3.4.80/flatpack/vector_manager.py
-drwxr-xr-x   0 romlingroup   (501) staff       (20)        0 2024-05-20 08:27:55.425758 flatpack-3.4.80/flatpack.egg-info/
--rw-r--r--   0 romlingroup   (501) staff       (20)     6253 2024-05-20 08:27:55.000000 flatpack-3.4.80/flatpack.egg-info/PKG-INFO
--rw-r--r--   0 romlingroup   (501) staff       (20)      636 2024-05-20 08:27:55.000000 flatpack-3.4.80/flatpack.egg-info/SOURCES.txt
--rw-r--r--   0 romlingroup   (501) staff       (20)        1 2024-05-20 08:27:55.000000 flatpack-3.4.80/flatpack.egg-info/dependency_links.txt
--rw-r--r--   0 romlingroup   (501) staff       (20)       48 2024-05-20 08:27:55.000000 flatpack-3.4.80/flatpack.egg-info/entry_points.txt
--rw-r--r--   0 romlingroup   (501) staff       (20)      313 2024-05-20 08:27:55.000000 flatpack-3.4.80/flatpack.egg-info/requires.txt
--rw-r--r--   0 romlingroup   (501) staff       (20)        9 2024-05-20 08:27:55.000000 flatpack-3.4.80/flatpack.egg-info/top_level.txt
--rw-r--r--   0 romlingroup   (501) staff       (20)       38 2024-05-20 08:27:55.426498 flatpack-3.4.80/setup.cfg
--rw-r--r--   0 romlingroup   (501) staff       (20)     1090 2024-05-20 08:27:48.000000 flatpack-3.4.80/setup.py
...
### Comparing `flatpack-3.4.80/LICENSE` & `flatpack-3.4.9/LICENSE`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.80/PKG-INFO` & `flatpack-3.4.9/PKG-INFO`
...
### Comparing `flatpack-3.4.80/README.md` & `flatpack-3.4.9/README.md`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.80/flatpack/agent_manager.py` & `flatpack-3.4.9/flatpack/agent_manager.py`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.80/flatpack/datasets.py` & `flatpack-3.4.9/flatpack/datasets.py`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.80/flatpack/instructions.py` & `flatpack-3.4.9/flatpack/instructions.py`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.80/flatpack/main.py` & `flatpack-3.4.9/flatpack/main.py`
...
### Comparing `flatpack-3.4.80/flatpack/modules/lstm.py` & `flatpack-3.4.9/flatpack/modules/lstm.py`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.80/flatpack/modules/rnn.py` & `flatpack-3.4.9/flatpack/modules/rnn.py`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.80/flatpack/parsers.py` & `flatpack-3.4.9/flatpack/parsers.py`
...
### Comparing `flatpack-3.4.80/flatpack/vector_manager.py` & `flatpack-3.4.9/flatpack/vector_manager.py`
...
### Comparing `flatpack-3.4.80/flatpack.egg-info/PKG-INFO` & `flatpack-3.4.9/flatpack.egg-info/PKG-INFO`
...
### Comparing `flatpack-3.4.80/flatpack.egg-info/SOURCES.txt` & `flatpack-3.4.9/flatpack.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.80/setup.py` & `flatpack-3.4.9/setup.py`
