# Comparing `tmp/flatpack-3.4.87.tar.gz` & `tmp/flatpack-3.4.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "flatpack-3.4.87.tar", last modified: Mon May 20 15:07:00 2024, max compression
+gzip compressed data, was "flatpack-3.4.9.tar", last modified: Thu May  2 22:54:15 2024, max compression
```

## Comparing `flatpack-3.4.87.tar` & `flatpack-3.4.9.tar`

### file list

```diff
@@ -1,33 +1,33 @@
-drwxr-xr-x   0 romlingroup   (501) staff       (20)        0 2024-05-20 15:07:00.790975 flatpack-3.4.87/
--rw-r--r--   0 romlingroup   (501) staff       (20)    11357 2024-01-31 06:56:56.000000 flatpack-3.4.87/LICENSE
--rw-r--r--   0 romlingroup   (501) staff       (20)     6253 2024-05-20 15:07:00.790707 flatpack-3.4.87/PKG-INFO
--rw-r--r--   0 romlingroup   (501) staff       (20)     5422 2024-05-18 05:22:15.000000 flatpack-3.4.87/README.md
-drwxr-xr-x   0 romlingroup   (501) staff       (20)        0 2024-05-20 15:07:00.788303 flatpack-3.4.87/flatpack/
--rw-r--r--   0 romlingroup   (501) staff       (20)      138 2024-05-02 14:39:05.000000 flatpack-3.4.87/flatpack/__init__.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     2494 2024-05-02 07:38:12.000000 flatpack-3.4.87/flatpack/agent_manager.py
--rw-r--r--   0 romlingroup   (501) staff       (20)      407 2024-01-31 06:56:56.000000 flatpack-3.4.87/flatpack/config.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     1029 2024-01-31 06:56:56.000000 flatpack-3.4.87/flatpack/datasets.py
-drwxr-xr-x   0 romlingroup   (501) staff       (20)        0 2024-05-20 15:07:00.789616 flatpack-3.4.87/flatpack/engines/
--rw-r--r--   0 romlingroup   (501) staff       (20)        0 2024-04-29 23:17:03.000000 flatpack-3.4.87/flatpack/engines/__init__.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     1475 2024-05-20 10:20:46.000000 flatpack-3.4.87/flatpack/engines/engine_llama_cpp.py
--rw-rw-r--   0 romlingroup   (501) staff       (20)     1057 2023-09-28 21:46:27.000000 flatpack-3.4.87/flatpack/instructions.py
--rw-r--r--   0 romlingroup   (501) staff       (20)       52 2024-05-18 04:12:26.000000 flatpack-3.4.87/flatpack/load_engines.py
--rw-r--r--   0 romlingroup   (501) staff       (20)       59 2024-01-31 06:56:56.000000 flatpack-3.4.87/flatpack/load_modules.py
--rw-r--r--   0 romlingroup   (501) staff       (20)    34886 2024-05-20 14:53:14.000000 flatpack-3.4.87/flatpack/main.py
-drwxr-xr-x   0 romlingroup   (501) staff       (20)        0 2024-05-20 15:07:00.790113 flatpack-3.4.87/flatpack/modules/
--rw-r--r--   0 romlingroup   (501) staff       (20)        0 2024-01-31 06:56:56.000000 flatpack-3.4.87/flatpack/modules/__init__.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     4297 2024-01-31 06:56:56.000000 flatpack-3.4.87/flatpack/modules/lstm.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     4292 2024-01-31 06:56:56.000000 flatpack-3.4.87/flatpack/modules/rnn.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     6983 2024-05-14 17:52:21.000000 flatpack-3.4.87/flatpack/parsers.py
--rw-r--r--   0 romlingroup   (501) staff       (20)      290 2024-04-27 11:31:48.000000 flatpack-3.4.87/flatpack/session_manager.py
--rw-r--r--   0 romlingroup   (501) staff       (20)      184 2024-01-31 06:56:56.000000 flatpack-3.4.87/flatpack/utils.py
--rw-r--r--   0 romlingroup   (501) staff       (20)     8439 2024-05-20 15:06:16.000000 flatpack-3.4.87/flatpack/vector_manager.py
-drwxr-xr-x   0 romlingroup   (501) staff       (20)        0 2024-05-20 15:07:00.790372 flatpack-3.4.87/flatpack.egg-info/
--rw-r--r--   0 romlingroup   (501) staff       (20)     6253 2024-05-20 15:07:00.000000 flatpack-3.4.87/flatpack.egg-info/PKG-INFO
--rw-r--r--   0 romlingroup   (501) staff       (20)      636 2024-05-20 15:07:00.000000 flatpack-3.4.87/flatpack.egg-info/SOURCES.txt
--rw-r--r--   0 romlingroup   (501) staff       (20)        1 2024-05-20 15:07:00.000000 flatpack-3.4.87/flatpack.egg-info/dependency_links.txt
--rw-r--r--   0 romlingroup   (501) staff       (20)       48 2024-05-20 15:07:00.000000 flatpack-3.4.87/flatpack.egg-info/entry_points.txt
--rw-r--r--   0 romlingroup   (501) staff       (20)      313 2024-05-20 15:07:00.000000 flatpack-3.4.87/flatpack.egg-info/requires.txt
--rw-r--r--   0 romlingroup   (501) staff       (20)        9 2024-05-20 15:07:00.000000 flatpack-3.4.87/flatpack.egg-info/top_level.txt
--rw-r--r--   0 romlingroup   (501) staff       (20)       38 2024-05-20 15:07:00.791033 flatpack-3.4.87/setup.cfg
--rw-r--r--   0 romlingroup   (501) staff       (20)     1090 2024-05-20 15:06:38.000000 flatpack-3.4.87/setup.py
...
### Comparing `flatpack-3.4.87/LICENSE` & `flatpack-3.4.9/LICENSE`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.87/PKG-INFO` & `flatpack-3.4.9/PKG-INFO`
...
### Comparing `flatpack-3.4.87/README.md` & `flatpack-3.4.9/README.md`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.87/flatpack/agent_manager.py` & `flatpack-3.4.9/flatpack/agent_manager.py`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.87/flatpack/datasets.py` & `flatpack-3.4.9/flatpack/datasets.py`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.87/flatpack/instructions.py` & `flatpack-3.4.9/flatpack/instructions.py`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.87/flatpack/main.py` & `flatpack-3.4.9/flatpack/main.py`
...
### Comparing `flatpack-3.4.87/flatpack/modules/lstm.py` & `flatpack-3.4.9/flatpack/modules/lstm.py`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.87/flatpack/modules/rnn.py` & `flatpack-3.4.9/flatpack/modules/rnn.py`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.87/flatpack/parsers.py` & `flatpack-3.4.9/flatpack/parsers.py`
...
### Comparing `flatpack-3.4.87/flatpack.egg-info/PKG-INFO` & `flatpack-3.4.9/flatpack.egg-info/PKG-INFO`
...
### Comparing `flatpack-3.4.87/flatpack.egg-info/SOURCES.txt` & `flatpack-3.4.9/flatpack.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `flatpack-3.4.87/setup.py` & `flatpack-3.4.9/setup.py`
