# Comparing `tmp/imsciences-0.5.7.8.tar.gz` & `tmp/imsciences-0.5.7.9.tar.gz`
...
## Comparing `imsciences-0.5.7.8.tar` & `imsciences-0.5.7.9.tar`
...
### Comparing `imsciences-0.5.7.8/PKG-INFO` & `imsciences-0.5.7.9/PKG-INFO`
...
### Comparing `imsciences-0.5.7.8/README.md` & `imsciences-0.5.7.9/README.md`

 * *Files identical despite different names*

### Comparing `imsciences-0.5.7.8/imsciences/datafunctions.py` & `imsciences-0.5.7.9/imsciences/datafunctions.py`
...
### Comparing `imsciences-0.5.7.8/imsciences.egg-info/PKG-INFO` & `imsciences-0.5.7.9/imsciences.egg-info/PKG-INFO`
...
### Comparing `imsciences-0.5.7.8/setup.py` & `imsciences-0.5.7.9/setup.py`
