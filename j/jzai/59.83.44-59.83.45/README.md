# Comparing `tmp/jzai-59.83.44.tar.gz` & `tmp/jzai-59.83.45.tar.gz`
...
## Comparing `jzai-59.83.44.tar` & `jzai-59.83.45.tar`
...
### Comparing `jzai-59.83.44/jzai/bot.py` & `jzai-59.83.45/jzai/bot.py`

 * *Files identical despite different names*

### Comparing `jzai-59.83.44/jzai/db.py` & `jzai-59.83.45/jzai/db.py`
